...
@section('content')
  ...
  <div class="table-responsive">
    <table id="Clasificaciones" class="table table-striped" style="width:100%">
      <thead>
        <tr>
          <th>Clasificación</th>
          <th>Institución</th>
              ...
              <div class="d-flex justify-content-center">
                ...
                <form action="{{route('clasificaciones.destroy', $clasificacion->id)}}" class="float-right" method="post">
                    ...
                    <button type="button" class="btn btn-outline-danger btn-sm rounded delete-confirm-btn" data-bs-toggle="popover" data-bs-trigger="focus" data-bs-placement="left" data-bs-html="true"
                      ...
                      data-bs-content="Quienes eliminar a esta clasificación?<div class='mt-2 text-end'><button type='button' class='btn btn-sm btn-danger confirm-delete'>Si</button><button type='button' class='btn btn-sm btn-secondary ms-1 cancel-delete'>No</button></div>"><i class="fas fa-trash-alt"></i></button>
                  </form>
              </div>
            </td>
          </tr>
